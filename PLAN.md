...
> ⚠️ **Исторический документ, версия 1 от 17.09.2026.** Актуальное состояние — в
> [CLAUDE.md](CLAUDE.md) и [docs/REQUIREMENTS.md](docs/REQUIREMENTS.md). В частности,
> голосового меню больше нет, приветствие не перебивается, предел фразы 12 с.
>
> **Проект:** голосовой ИИ-оператор колл-центра Министерства высшего образования (задачи №5 и №3 из `docs/xorazm_dolzarb_muammolar.pdf`).
